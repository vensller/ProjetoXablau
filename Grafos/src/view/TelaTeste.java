...
//        JButton botao = new JButton();
    ...
    public static void main(String args[]) {
        ...
        a1 = new Aresta( v1, v2, 1*mul, false, "a1");
        listaDesenhaveis.add( a1 );
        
        a2 = new Aresta( v3, v2, 1*mul, false, "a2");
        listaDesenhaveis.add( a2 );
        
        a3 = new Aresta( v4, v2, 1*mul, false, "a3");
        listaDesenhaveis.add( a3 );
        
        a4 = new Aresta( v5, v2, 1*mul, false, "a4");
        listaDesenhaveis.add( a4 );
        
        a5 = new Aresta( v5, v6, 1*mul, false, "a5");
